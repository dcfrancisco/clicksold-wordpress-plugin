...
?>  </div>
  ...
  <script type="text/javascript">
	(function($){
		$(document).ready(function() {
			if("<?php echo $this->id; ?>".match("__i__$") == null) {
				$('.<?php echo $this->id; ?>:not(div[class$="__i__"])').csSellingInfoWidget({
	...
	function initUnsavedSellingInfoWidget(self, eventType){
		(function($){ 
			if("<?php echo $this->id; ?>".match("__i__$") != null) {
			...
			<?php } ?>		
				...
				$("." + bi_w + ":not(div[class$='__i__'])").csSellingInfoWidget("checkInit", opts, function(){
