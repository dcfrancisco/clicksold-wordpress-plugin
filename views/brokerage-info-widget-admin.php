...
?>
  ...
  <p>
    ...
    <select class="widefat" id="<?php echo $this->get_field_id('logo_src'); ?>" name="<?php echo $this->get_field_name('logo_src'); ?>" onchange="initUnsavedBrokInfoWidget(this)" >
	...
	function initUnsavedBrokInfoWidget(self){
		(function($){ 
			if("<?php echo $this->id; ?>".match("__i__$")) {
				...
				opts.logo_src_id = opts.logo_src_id.replace(/__i__/g, bi_w_id);
				opts.upload_logo_src_id = opts.upload_logo_src_id.replace(/__i__/g, bi_w_id);
				opts.img_upload_src = opts.img_upload_src.replace(/__i__/g, bi_w_id);
				opts.preview_img_cnt = opts.preview_img_cnt.replace(/__i__/g, bi_w_id);
